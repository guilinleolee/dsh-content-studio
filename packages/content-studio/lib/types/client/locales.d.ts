...
export declare const zh: {
    ...
    readonly 'nav.create': "创作";
    readonly 'nav.chat': "对话";
    readonly 'nav.benchmark': "对标";
    readonly 'nav.topics': "选题";
    readonly 'nav.content': "内容";
    ...
    readonly 'topics.title': "选题规划";
    readonly 'accounts.title': "账号管理";
    readonly 'accounts.hint': "选择当前创作账号；账号会注入到每条复制的创作指令中。";
    readonly 'accounts.delete': "删除账号";
    readonly 'account.active': "当前";
    readonly 'persona.title': "画像设定";
    readonly 'persona.hint': "描述该账号的定位、人设、语气与目标受众；保存后随创作指令一起注入。";
    readonly 'persona.placeholder': "例：专注 AI 工具测评的科技博主，语气专业但亲切，受众为 25-40 岁职场人群……";
    readonly 'persona.save': "保存画像";
    readonly 'persona.saved': "已保存";
